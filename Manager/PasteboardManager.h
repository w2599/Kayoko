...
#define kHistoryPath ROOT_PATH_NS_VAR(@"/var/mobile/Documents/dev.traurige/Kayoko/history.json")
#define kHistoryImagesPath ROOT_PATH_NS_VAR(@"/var/mobile/Documents/dev.traurige/Kayoko/images/")
