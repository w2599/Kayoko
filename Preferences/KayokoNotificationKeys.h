...
static NSString *const kKayokoNotificationKeyCoreResetThumbnailMemoryCache = @"com.zqbb.kayoko.core.reset-thumbnail-memory-cache";
...
static NSString *const kKayokoNotificationKeyCoreAddRandomImageItems = @"com.zqbb.kayoko.core.add-random-image-items";
static NSString *const kKayokoNotificationKeyCoreImportLegacyFavorites = @"com.zqbb.kayoko.core.import-legacy-favorites";
...
static NSString *const kKayokoNotificationKeyExternalImportRequiresRestart = @"com.zqbb.kayoko.preferences.external-import-requires-restart";
